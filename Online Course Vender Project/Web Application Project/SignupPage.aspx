<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignupPage.aspx.cs" Inherits="Web_Application_Project.SignupPage" %>
                ...
                <div class="col-8 col-sm-8 col-md-6 ">
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            <h2 class="signuphd">Start programming life now</h2>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center mr-2">
                        <div class="col-5 col-sm-6">
                            <asp:TextBox ID="tboxEmail" runat="server" class="form-control" Height="40px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvEmail" runat="server" ErrorMessage="Email (ID) is required" ControlToValidate="tboxEmail" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="rgvEmail" runat="server" ErrorMessage="Invalid email format" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ControlToValidate="tboxEmail" Display="Dynamic" ForeColor="Red"></asp:RegularExpressionValidator>
                        </div>
                        <div class="col-5 col-sm-6">
                            ...
                            <asp:RegularExpressionValidator ID="rgvPassword" runat="server" ErrorMessage="Please give a password between 8 to 25" ValidationExpression="^([a-zA-Z0-9]){8,25}$" Display="Dynamic" ControlToValidate="tboxPassword" ForeColor="Red"></asp:RegularExpressionValidator>
                    ...
                    <div class="row mt-5">
                        <div class="col-lg-12 text-center">
                            <asp:Button ID="btnSignUp" runat="server" Text="Sign Up" CssClass="btn btn-primary btn-lg" OnClick="btnSignUp_Click" />
                        </div>
                    </div>
                </div>
            </div>
